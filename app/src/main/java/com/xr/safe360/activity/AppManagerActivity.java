...
import com.xr.safe360.engine.AppInfoProvider;
...
public class AppManagerActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void showPopupWindow(View clickView){
        ...
        mPopupWindow.showAsDropDown(clickView, clickView.getHeight() * 2, -3 * clickView.getHeight() / 2);
    ...
    private void initTitle() {
        ...
        Long pathSpace = getAvailSpace(path);
        Long sdSpace = getAvailSpace(sdPath);
        String memoryAvailSpace = Formatter.formatFileSize(this, pathSpace);
